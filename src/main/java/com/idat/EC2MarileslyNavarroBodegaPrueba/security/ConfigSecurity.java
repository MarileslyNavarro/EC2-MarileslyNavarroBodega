...
//		auth.inMemoryAuthentication().withUser("user").password(encriptado().encode("123456") ).roles("USER");
//		auth.inMemoryAuthentication().withUser("admin").password(encriptado().encode("123456")).roles("ADMIN");
